...
LINKER = linker.ld
LINKER_FILES = $(BUILD_DIR)/multiboot_header.o $(BUILD_DIR)/starter.o $(BUILD_DIR)/gdt.o $(BUILD_DIR)/idt.o $(KERNEL_OBJECT) $(BUILD_DIR)/vga_buffer.elf $(BUILD_DIR)/heap.o $(BUILD_DIR)/paging.o  $(BUILD_DIR)/page_allocator.o $(BUILD_DIR)/string.o
DEBUG_FLAGS = -g
...
build_: $(INIT_KERNEL_FILES) $(BOOTSTRAP_FILE) $(KERNEL_FILES)
	...
	$(CC) $(KERNEL_FLAGS) $(SRC_DIR)/mm/heap/heap.c -o $(BUILD_DIR)/heap.o
