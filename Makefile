...
LINKER = linker.ld
LINKER_FILES = $(BUILD_DIR)/multiboot_header.o $(BUILD_DIR)/starter.o $(BUILD_DIR)/gdt.o $(BUILD_DIR)/idt.o $(KERNEL_OBJECT) $(BUILD_DIR)/vga_buffer.elf $(BUILD_DIR)/heap.o $(BUILD_DIR)/paging.o 
DEBUG_FLAGS = -g
